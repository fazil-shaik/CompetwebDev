...
export default function Dashboard() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      console.error('Error sending webhook:', error)
      setStatus({ type: 'error', message: error instanceof Error ? error.message : 'An unexpected error occurred. Please try again.' })
    } finally {
      setIsLoading(false)
    }
  }
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div 
              ...
              dangerouslySetInnerHTML={{ __html: convertLinksToAnchors(message) }}
            />
          </div>
        </CardContent>
        <CardFooter className="flex flex-col items-start space-y-2">
